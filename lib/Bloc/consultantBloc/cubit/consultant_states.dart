...
class CallRecevedSucssesfully extends ConsultantStates {}

class AnswerVoiceCallSucsses extends ConsultantStates {}

class ErrorWithanswerCall extends ConsultantStates {
  final String error;

  ErrorWithanswerCall(this.error);
}
