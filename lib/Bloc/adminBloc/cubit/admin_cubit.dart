  ...
  void getUserInSecurity({
    ...
    FirebaseFirestore.instance.collection('users').get().then((value) {
      ...
      value.docs.forEach((element) {
        if (element.data()['uid'] != adminModel?.uid && element.data()['userType'] == "user"){
          userModel!.add(UserModel.fromJson(element.data()));
        }
        else if (element.data()['uid'] != adminModel?.uid && element.data()['accept'] == true ){
          accepted_consultant!.add(ConsultantModel.fromJson(element.data()));
        }
        else if (element.data()['uid'] != adminModel?.uid && element.data()['accept'] == false ){
