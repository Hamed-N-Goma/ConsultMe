...
class MyApp extends StatelessWidget {
  ...
  final bool? isDark;
  const MyApp({Key? key,  required this.appRouter , this.isDark}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      providers: [
        ...
        BlocProvider(create: (BuildContext context) => ConsultantCubit()..getConsultantData()..getPosts()),
        BlocProvider(create: (BuildContext context) => UserCubit()..getUserData()),
        BlocProvider(create: (BuildContext context) => AdminCubit()..getAdminData()..getUserInSecurity()..getData()),
        BlocProvider(create: (BuildContext context) => UserLayoutCubit()..GetUserInfo()),
